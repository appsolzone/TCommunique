...
import { IonicPage, NavController,ToastController,ModalController, NavParams,LoadingController,Loading} from 'ionic-angular';
...
SaveRequest(){
  ...
  onClickFuntion(){
    ...
    console.log("Hello");
      ...
      let myModal = this.modal.create(BusSearchListPage);
